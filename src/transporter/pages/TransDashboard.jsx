...
import TPSidebar from "../layouts/TPSidebar"
import TPHeader from "../layouts/TPHeader"
...
const TransDashboard = () => {
    ...
    return (
        ...
        <div className="flex min-h-screen dark:bg-[#212936] dark:text-gray-300">
            ...
            <div className="fized">
                <TPSidebar toggleSidebar={toggleSidebar} isOpen={isSidebarOpen} />
            </div>
            <div className="flex flex-col w-full gap-y-4 text-3xl semibold h-full">
                <div className="mb-16">
                    {/* Manufacturers Header component is included */}
                    <TPHeader toggleSidebar={toggleSidebar} isOpen={isSidebarOpen} />
                </div>
